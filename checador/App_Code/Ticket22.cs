...
namespace BarControlsd
{
    public class Ticket
    {
        ...
        private System.Drawing.Image headerImage = null;
        ...
        public System.Drawing.Image HeaderImage
        {
        ...
        public void PrintTicket(string impresora ,ref string strprint)
        {
            ...
            try
            {
                ...
                strprint = pr.PrinterSettings.PrinterName.ToString();
            ...
            {
                Exception obj = new Exception(strprint);
